...
(1005, 'SnackAttack', 'Plantain Chips', 1.0, 'These are like rocks! yuck!', 'plantain-chips.webp', 0),
...
(1009, 'SnackAttack', 'Milk Chocolate Peanut Butter Cups', 2.0, 'I have never thrown up so fast after eating a food before!', 'milk-chocolate-peanut-butter-cup.webp', 0),
...
(1013, 'SnackAttack', 'Oven-Baked Cheese Bites', 3.0, 'This one was not that bad, but still needs improvement', 'oven-baked-cheese-bites.webp', 0),
...
(1017, 'SnackAttack', 'Tangy Turtles', 1.0, 'Tangy Turtles? More like Terrible Turtles!', 'tangy-turtles.webp', 0),
...
(1021, 'SnackAttack', 'Slightly Coated Dark Chocolate Almonds', 2.0, 'Only slightly bad', 'slightly-coated-dark-chocolate-almonds.webp', 0),
...
(1025, 'SnackAttack', 'Belgian Butter Waffle Cookies', 1.0, '*thumbs down*', 'belgian-butter-waffle-cookies.webp', 0),
